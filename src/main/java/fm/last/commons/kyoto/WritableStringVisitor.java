 ...
 */
public interface WritableStringVisitor {

  /** No operation */
  public static final String NOP = new String(Visitor.NOP);
  /** Remove record */
  public static final String REMOVE = new String(Visitor.REMOVE);
   ...
   * @return {@link #REMOVE} to remove the record, {@link #NOP} to leave the record unchanged, or a <code>String</code>
